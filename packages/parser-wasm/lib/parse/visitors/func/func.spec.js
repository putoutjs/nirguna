...
test('nirguna: parser-wasm: parser: visitors: func: func-multi-value-result', (t) => {
...
test('nirguna: parser-wasm: parser: visitors: func: func-negative-const', (t) => {
    t.transform('func-negative-const');
    t.end();
});
