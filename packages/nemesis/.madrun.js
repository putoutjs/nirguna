...
export default {
    ...
    'build': () => {
        return [
            '../nirguna/bin/nirguna.spec.js -t fasm lib/kernel.ts',
            '../nirguna/bin/nirguna.spec.js -t fasm lib/boot/index.js',
            '../nirguna/bin/nirguna.spec.js -t fasm lib/shell/shell.ts',
            './scripts/build.js',
